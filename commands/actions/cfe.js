...
exports.cfe = function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, get_fiscal_account_1.getFiscalAccount(params.email, params.password, params.siren, false)];
            case 1:
                _a = _b.sent(), browser = _a.browser, page = _a.page;
                url = "https://cfspro.impots.gouv.fr/webadelie/servlet/voirTableauAvisCFEEnsembleAdresses.html?&vue=usager&t=L&siren=" + params.siren;
                // go to declarations page
                return [4 /*yield*/, page.goto(function () {
            ...
            case 4:
                _b.sent();
                return [3 /*break*/, 6];
            case 5: return [2 /*return*/, { browser: browser, page: page }];
