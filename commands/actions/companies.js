        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, page_1.goto(COMPANIES_URL, {
                ...
                case 3:
                    links = _d.sent();
                    extractCompanies_1 = function (page) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            ...
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, page.evaluate(function () {
                                        return Array.from(document.querySelectorAll('#ins_contenu > form > table.listing.onecol > tbody label'))
                                            ...
                                            .map(function (company) { return company.split("SIREN"); })
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.all(links.map(function (link) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, page_1.goto(link, {
                                            timeout: const_1.TIMEOUT,
                                            waitUntil: 'domcontentloaded'
                                        })];
                                    case 1:
