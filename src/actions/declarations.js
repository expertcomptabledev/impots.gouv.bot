        ...
        case 5:
          ...
          return [
            ...
            page.evaluate(function() {
              return Array.from(document.querySelectorAll('.tableau_pliable')).map(function(tableau) {
    ...
    return tslib_1.__generator(this, function(_a) {
      switch (_a.label) {
        ...
        case 6:
          return [
            4 /*yield*/,
            page.evaluate(function(menuSelector) {
        ...
        case 7:
          ...
          linkPrint =
            links.filter(function(l) {
              return l.indexOf('lancerImpression') > -1;
            })[0] || null;
          if (!!linkPrint) return [3 /*break*/, 8];
          return [2 /*return*/, null];
        case 8:
          return [4 /*yield*/, page.goto(linkPrint, { timeout: const_1.TIMEOUT, waitUntil: 'domcontentloaded' })];
        case 9:
          response = _a.sent();
            ...
            page.waitForFunction(
              function(pdfId) {
                ...
                var res = Array.from(document.querySelectorAll('.outil a'))
                  ...
                  .filter(function(a) {
                    return a.indexOf(pdfId) > -1 && a.indexOf('getPdf') > -1;
                  });
                return res.length > 0;
              },
        ...
        case 11:
          ...
          return [
            4 /*yield*/,
            page.evaluate(function(pdfId) {
              return Array.from(document.querySelectorAll('.outil a'))
                .map(function(node) {
                  return node.href;
                })
                .filter(function(a) {
                  return a.indexOf(pdfId) > -1;
                })[0];
            }, idPdf),
        ...
        case 12:
          ...
          return [
            4 /*yield*/,
            page.evaluate(function(downloadLink) {
